      ...
      <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
            ...
            <div className="relative max-w-3xl">
              ...
              <h1 className="max-w-2xl text-4xl font-semibold leading-tight tracking-tight sm:text-5xl lg:text-6xl">
                ...
                <span className="block text-zinc-400">
                  который строит процесс, а не только закрывает задачи.
                </span>
              </h1>

              <p className="mt-5 max-w-2xl text-base leading-7 text-zinc-300 sm:text-lg">
                Управляю продакшном, командами, логистикой и операционкой.
                Соединяю креатив, процессное мышление и контроль результата —
                от первой вводной до стабильной рабочей системы.
              </p>
              ...
              <div className="mt-7 grid gap-3 sm:grid-cols-2">
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                  ...
                  <div className="mt-2 text-sm leading-6 text-zinc-200">
                    Иду от задачи к системе: роли, процессы, контрольные точки,
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                  ...
                  <div className="mt-2 text-sm leading-6 text-zinc-200">
                    Роли на стыке project management, production, operations и
                    развития процессов.
                  </div>
                </div>
              </div>
            ...
            <div className="grid gap-4">
              <div className="rounded-[30px] border border-white/10 bg-zinc-900 p-5 sm:p-6">
                ...
                <div className="mt-3 text-2xl font-semibold leading-tight">
                  Не просто делаю контент.
                </div>
                <p className="mt-3 text-sm leading-6 text-zinc-300">
                  Выстраиваю систему работы: люди, роли, процессы, контроль,
                  качество, дедлайны, коммуникация и результат на выходе.
                </p>
              </div>

              <div className="rounded-[30px] border border-white/10 bg-zinc-900 p-5 sm:p-6">
                <div className="text-xs uppercase tracking-[0.22em] text-zinc-500">
                  Какие роли рассматриваю
                </div>
        ...
        <section className="mt-4 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {metrics.map((item) => (
            <div
              key={item.label}
              className="rounded-[24px] border border-white/10 bg-zinc-900 p-5"
            >
        ...
        <section className="mt-4 grid gap-4 lg:grid-cols-[0.78fr_1.22fr]">
          ...
          <div className="rounded-[30px] border border-white/10 bg-zinc-900 p-6 sm:p-8">
            <div className="text-xs uppercase tracking-[0.22em] text-zinc-500">
              Почему сайт должен работать на отклики
            </div>
            <div className="mt-3 grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-zinc-300">
                  Команды, большие события, бюджеты, контент и процессы — всё с
                  цифрами.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-zinc-300">
                  Через систему: PDCA, BPMN, контроль точек риска и управляемый
                  результат.
                </p>
              </div>
            </div>
        ...
        <section id="cases" className="mt-16">
          <div className="mb-6">
            ...
            <h2 className="mt-2 text-3xl font-semibold tracking-tight sm:text-4xl">
              Разные типы задач, которые я умею собирать в систему
            </h2>
          </div>
            ...
            {caseCards.map((item) => (
              ...
              >
                <img
                  src={item.image}
                  alt={item.title}
                  className="absolute inset-0 h-full w-full object-cover opacity-35 transition duration-300 group-hover:scale-105 group-hover:opacity-50"
                />
        ...
        <section
          id="glowbyte"
          className="mt-16 rounded-[30px] border border-white/10 bg-zinc-900 p-6 sm:p-8"
        >
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div>
              ...
              <h3 className="mt-2 text-3xl font-semibold tracking-tight">
                GlowByte — медиа-сопровождение корпоратива
              </h3>
              <div className="mt-4 flex flex-wrap gap-2">
                {[
                  "6 фотографов",
              ...
              <p className="mt-5 text-base leading-7 text-zinc-300">
                Организовал фото- и видеапродакшн под корпоративное мероприятие
                с контентом для отчётности, внутренних коммуникаций и
          ...
          <div className="mt-6 grid gap-4 lg:grid-cols-3">
            <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-300">
                Работа велась по формализованному ТЗ: отчётный фильм 5–10 минут,
                ролики для соцсетей, охват ключевых моментов и фиксация
            ...
            <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-300">
                Собрал команду, распределил зоны съёмки, зафиксировал требования
                к контенту, выстроил pipeline: съёмка → отбор → обработка →
                сдача.
              </p>
            </div>
            ...
            <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-300">
                3000+ уникальных фотографий без дублей, 2 итоговых видео, около
                20 reels, структурированная выдача материалов в срок.
              </p>
            </div>
          </div>
        ...
        >
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div>
              ...
              <h3 className="mt-2 text-3xl font-semibold tracking-tight">
                Медиавыпускной — продюсирование мероприятия
              </h3>
              <div className="mt-4 flex flex-wrap gap-2">
                {[
                  "сценарий",
              ...
              <p className="mt-5 text-base leading-7 text-zinc-300">
                Организовал мероприятие с награждением, сценарием, таймингом,
                визуальной системой и несколькими направлениями работы, идущими
                параллельно.
              </p>
            </div>
          ...
          <div className="mt-6 grid gap-4 lg:grid-cols-3">
            <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-300">
                Сценарий, логику блоков, взаимодействие направлений, тайминги,
            ...
            <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-300">
                Команда под моим управлением делала дизайн и моушен для сцены,
                анонсов, носителей и digital-материалов, встроенных в общий
                сценарий события.
              </p>
            </div>
            ...
            <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
              <div className="text-sm font-semibold">Результат</div>
              <p className="mt-3 text-sm leading-6 text-zinc-300">
                Собранная и синхронизированная система подготовки: сценарий,
                задачи, тайминги, смета, визуал и команда, работающая в одном
                ритме.
              </p>
            </div>
          </div>
        ...
        >
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div>
              ...
              <h3 className="mt-2 text-3xl font-semibold tracking-tight">
                GF — выручка, вал и управленческие гипотезы
              </h3>
              <div className="mt-4 flex flex-wrap gap-2">
                {["план / факт", "ежедневный контроль", "вал", "решения"].map(
                  (item) => (
                    <span
                      key={item}
              ...
              <p className="mt-5 text-base leading-7 text-zinc-300">
                Систематизировал ежедневные показатели, сравнивал план и факт,
                отслеживал динамику по точкам и формировал гипотезы для
          ...
          <div className="mt-6 grid gap-4 lg:grid-cols-3">
            <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-300">
                Собирал и структурировал данные по выручке, визуализировал план
                / факт и отклонения, отслеживал динамику и выделял проблемные
                точки.
              </p>
            </div>
            ...
            <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-300">
                Не ограничивался цифрами: предлагал гипотезы по обучению,
                корпоративной культуре, сетям, адаптации новых сотрудников и
            ...
            <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
              <div className="text-sm font-semibold">Результат</div>
              <p className="mt-3 text-sm leading-6 text-zinc-300">
                Появилась прозрачная система контроля, база для управленческих
                решений и более предметный разговор о росте, просадках и точках
                оптимизации.
              </p>
            </div>
          </div>
        ...
        >
          <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              ...
              <h3 className="mt-2 text-3xl font-semibold tracking-tight">
                Проектирование и оптимизация процессов (BPMN)
              </h3>
              <div className="mt-4 flex flex-wrap gap-2">
                {[
                  "5+ ролей",
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
                  ...
                  <p className="mt-3 text-sm leading-6 text-zinc-300">
                    Разложил процесс на этапы, выделил роли, зафиксировал точки
                ...
                <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
                  ...
                  <p className="mt-3 text-sm leading-6 text-zinc-300">
                    Прозрачный процесс, понятные зоны ответственности, снижение
                    риска потерь задач и ускорение согласований.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section
          id="process"
          className="mt-16 grid gap-4 lg:grid-cols-[0.9fr_1.1fr]"
        >
          <div className="rounded-[30px] border border-white/10 bg-zinc-900 p-6 sm:p-8">
            <div className="text-xs uppercase tracking-[0.22em] text-zinc-500">
              Подход
            ...
            <h2 className="mt-2 text-3xl font-semibold tracking-tight sm:text-4xl">
              PDCA как рабочая логика, а не красивая аббревиатура
            </h2>
            <p className="mt-4 max-w-xl text-base leading-7 text-zinc-300">
              Мне важен не только факт выполнения задачи, а то, как система
              работает в целом: где сыпется, где перегружает команду, где даёт
              лишние итерации и как это перевести в следующую, более устойчивую
              версию.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {process.map((item) => (
              <div
                key={item.step}
                className="rounded-[30px] border border-white/10 bg-zinc-900 p-6"
              >
                <div className="text-sm font-medium uppercase tracking-[0.22em] text-orange-300">
                  {item.step}
                </div>
        ...
        <section
          id="tools"
          className="mt-16 grid gap-4 lg:grid-cols-[0.8fr_1.2fr]"
        >
          <div className="rounded-[30px] border border-white/10 bg-zinc-900 p-6 sm:p-8">
            <div className="text-xs uppercase tracking-[0.22em] text-zinc-500">
              Инструменты
            ...
            <p className="mt-4 text-base leading-7 text-zinc-300">
              Я хорошо чувствую стык между контентом и операционкой: могу
              говорить и с креативной командой, и с теми, кому нужны порядок,
        ...
        <section
          id="contacts"
          className="mt-16 mb-8 overflow-hidden rounded-[30px] border border-white/10 bg-white text-zinc-950"
        >
          <div className="grid gap-6 p-6 sm:p-8 lg:grid-cols-[1fr_auto] lg:items-end lg:gap-8 lg:p-10">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-semibold tracking-tight sm:text-4xl">
                Готов подключаться к проектам, где важны система, темп и
                результат
              </h2>
              <p className="mt-4 max-w-2xl text-base leading-7 text-zinc-700">
                Интересны роли на стыке проектного управления, продакшна,
                операционки и развития процессов. Особенно там, где нужно не
                просто закрывать задачи, а собирать рабочую структуру из хаоса.
              </p>
            </div>
            ...
            <div className="grid gap-3 text-sm sm:min-w-[260px]">
              <a
                ...
                className="rounded-2xl border border-zinc-200 px-4 py-3 transition hover:bg-zinc-50"
              >
                anton6370@gmail.com
              </a>
              <a
