      ...
      <div className="mx-auto max-w-7xl px-4 pb-6 pt-28 sm:px-6 sm:pt-32 lg:px-8">
        ...
        <section id="graduation" className="mt-16 scroll-mt-28 rounded-[32px] border border-white/10 bg-zinc-950/85 p-5 shadow-[0_18px_70px_rgba(0,0,0,0.38)] backdrop-blur sm:scroll-mt-32 sm:p-8">
          ...
          <div className="mt-4 grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
            <div className="group rounded-[24px] border border-white/10 bg-black/20 p-2 transition duration-300 hover:-translate-y-0.5 hover:border-white/15 hover:bg-white/[0.03]">
              <video src="https://res.cloudinary.com/dvb1limg4/video/upload/motion-1_yehdvl.mp4" autoPlay muted loop playsInline controls className="aspect-[16/10] w-full rounded-[18px] bg-black object-cover" />
              <div className="px-2 pb-1 pt-3 text-xs uppercase tracking-[0.18em] text-zinc-500 transition duration-300 group-hover:text-zinc-300">Главный motion кейса</div>
            </div>
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
              <div className="group rounded-[24px] border border-white/10 bg-black/20 p-2 transition duration-300 hover:-translate-y-0.5 hover:border-white/15 hover:bg-white/[0.03]">
                <video src="https://res.cloudinary.com/dvb1limg4/video/upload/motion-2_njjnep.mp4" autoPlay muted loop playsInline controls className="aspect-[16/10] w-full rounded-[18px] bg-black object-cover" />
                <div className="px-2 pb-1 pt-3 text-xs uppercase tracking-[0.18em] text-zinc-500 transition duration-300 group-hover:text-zinc-300">Дополнительный motion</div>
              </div>
        ...
        <section id="glowbyte" className="mt-16 scroll-mt-28 rounded-[32px] border border-white/10 bg-zinc-950/85 p-5 shadow-[0_18px_70px_rgba(0,0,0,0.38)] backdrop-blur sm:scroll-mt-32 sm:p-8">
          ...
          <div className="mt-4 grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
            <div className="group rounded-[24px] border border-white/10 bg-black/20 p-2 transition duration-300 hover:-translate-y-0.5 hover:border-white/15 hover:bg-white/[0.03]">
              <video src="https://res.cloudinary.com/dvb1limg4/video/upload/video_t7tuw6.mp4" autoPlay muted loop playsInline controls className="aspect-[16/10] w-full rounded-[18px] bg-black object-cover" />
              <div className="px-2 pb-1 pt-3 text-xs uppercase tracking-[0.18em] text-zinc-500 transition duration-300 group-hover:text-zinc-300">Главное видео кейса</div>
            </div>
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
              <div className="group rounded-[24px] border border-white/10 bg-black/20 p-2 transition duration-300 hover:-translate-y-0.5 hover:border-white/15 hover:bg-white/[0.03]">
                <img src="/cases/glowbyte/contract-1.png" alt="Фрагмент ТЗ GlowByte" className="aspect-[16/10] w-full rounded-[18px] object-cover" />
